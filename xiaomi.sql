...
(1, 'jiunying', 'Kuan Jiun Ying', '123123'),
(2, 'jiayin', 'Lee Jia Yin', '123123'),
(3, 'peirui', 'Ong Pei Rui', '123123'),
(4, 'maryam', 'Nur Maryam Sufiah', '123123');
...
--
-- 转存表中的数据 `contact_inquiry`
--

INSERT INTO `contact_inquiry` (`id`, `fname`, `lname`, `email`, `subject`, `message`, `created_at`) VALUES
(28, 'KUAN', 'JIUN', 'jiunying2000kjy@gmail.com', 'Product details', 'xiaomi mi9', '2022-01-09 09:29:19'),
(29, 'kuan', 'jiunying', 'jiunying@gmail.com', 'Product Problems', 'xiaomi mi 9', '2022-01-09 13:37:31'),
(30, 'kuan ', 'jiun ying', 'jiunying@gmail.com', 'Product Problems', 'xiaomi', '2022-01-09 14:11:34'),
(31, 'kuan', 'jiun ying', 'jiunying@gmail.com', 'Product Problems', 'xiaomi', '2022-01-09 14:14:07'),
(32, 'kuan', 'jiun ying', 'jiunying@gmail.com', 'Product Problems', 'xiaomi mi 9', '2022-01-09 14:18:48'),
(33, 'kuan jiun ying', 'jiun ying', 'jiunying@gmail.com', 'Brand details', 'xiaomi', '2022-01-09 14:19:33'),
(34, 'jiun', 'ying', 'jiunying@gmail.com', 'Product details', '1', '2022-01-09 14:25:39');
...
('kjy', '$2y$10$7iB8AnBPeKwTcwfulhwCtOCLEWta4y6.ngtCQseGLBVe79tC9pXga', '2022-01-05 07:15:56', 19),
('kjy', '$2y$10$4YTNMjkCuU7R.J.YlMRpf.73X34wcGp7.E9vubE9OwFpiMaVSSPIG', '2022-01-09 09:29:42', 20),
('kuan', '$2y$10$XpkMlIYZjCZIs7HZs7UAm.50w.HW45hDTTtPy4a2KiDMh3P2cthEG', '2022-01-09 14:29:38', 21),
('kjykjy', '$2y$10$Szgk0RBnCwwwvBJqZ.Cn6uzxrMh47Z.snYbD1lNhCHR98qur4v8D.', '2022-01-09 14:35:59', 22);
...
--
-- 使用表AUTO_INCREMENT `contact_inquiry`
--
ALTER TABLE `contact_inquiry`
...
--
ALTER TABLE `review`
  MODIFY `review_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `cat` FOREIGN KEY (`product_category`) REFERENCES `categories` (`category_id`);
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `user` FOREIGN KEY (`review_user_id`) REFERENCES `users` (`user_id`);
COMMIT;
